...
class Education extends Component {
  ...
  addForms = (e) => {
    ...
    const EducationBox = (
      <div
        key={nextEducationId}
        data-key={nextEducationId}
        className={`educationForm_${nextEducationId}`}
        style={divStyle}
      >
        <LabelBox
          name={`cv_ins_${nextEducationId}`}
          labelInfo="Institution Name"
        />
        <InputBox name={`cv_ins_${nextEducationId}`} />
        <br />
        <LabelBox name={`cv_degree_${nextEducationId}`} labelInfo="Degree" />
        <InputBox name={`cv_degree_${nextEducationId}`} />
        <br />
        <LabelBox
          name={`cv_spcz_${nextEducationId}`}
          labelInfo="Specialization"
        />
        <InputBox name={`cv_spcz_${nextEducationId}`} />
        <br />
        <LabelBox name={`cv_years_from_${nextEducationId}`} labelInfo="From" />
        <InputBox
          classType="yearInput"
          name={`cv_years_from_${nextEducationId}`}
          placeholder="YYYY"
        ...
        <InputBox
          classType="yearInput"
          name={`cv_years_to_${nextEducationId}`}
          placeholder="YYYY"
          changeFunc={this.validateYears}
        />
        <br />
        <LabelBox
          name={`cv_grade_${nextEducationId}`}
          labelInfo="GPA/Percentage"
        />
    ...
    this.setState((prevState) => ({
      educationFormList: prevState.educationFormList.concat(EducationBox),
    }));
  };
